...
describe("RefBigInt", () => {
  ...
  it.effect("adds two BigInt values", () =>
    Effect.gen(function* () {
  ...
  it.effect("subtracts two BigInt values", () =>
    Effect.gen(function* () {
      const ref = yield* RefBigInt.make(BigInt_.BigInt(10))
  ...
  it.effect("multiplies two BigInt values", () =>
    Effect.gen(function* () {
